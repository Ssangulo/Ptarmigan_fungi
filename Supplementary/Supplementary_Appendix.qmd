...
## Section 7: Diet-tracking and Bayesian mechanism — H2/H3 {.page-break-before}
...
### 7.2 OTU–plant covariation (H3) *(placeholder)* {.unnumbered}

::: callout-warning
**To be integrated.** H3 — how *individual* fungal OTUs covary with the dietary plant community (tight single-plant covariation indicating likely ingested passengers, versus the diffuse, non-specific association expected of recognised coprophilous taxa) — is a distinct analysis (plant-predictor GLLVM / brms on the matched subset) and will be added here. It is conceptually separate from the diet-richness mechanism in 7.1 and from the E2 coprophilous-proxy documentation in Section 3.2.
:::
